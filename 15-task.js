...
+1 +21 для сетки 21 на 21. Если делится нацело на 21, то только + 21. Если это 440, то для него только на право. А если это 420, то для него только вниз.

Цикл запускаю от единицы и +22 каждый раз
*/

let arr = []

for (let i = 1 ; i <= 441; i+=21) {
    arr.push(i)
}
